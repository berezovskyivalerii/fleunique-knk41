...
export const ProfileLayout = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <Header />
      <div className="max-w-[1440px] mt-28 mx-auto px-10 xl:px-[160px] flex flex-col md:flex-row gap-8 py-10 relative z-10">
        <aside className="w-full md:w-[250px] shrink-0">
          <ProfileSidebar />
        </aside>

        <main className="w-[832px] flex rounded-[32px] bg-transparent justify-center p-4 pb-8 bg-white/20 backdrop-blur-[20px] [-webkit-backdrop-filter:blur(20px)] border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.08)]">
          <Outlet />
        </main>
      </div>
      <Footer />
