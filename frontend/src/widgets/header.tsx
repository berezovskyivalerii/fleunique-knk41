...
export function Header() {
  ...
  return (
    <header className="fixed top-8 left-0 right-0 z-50 w-[93%] mx-auto h-16 flex justify-between items-center px-8 rounded-4xl backdrop-blur-[20px] [-webkit-backdrop-filter:blur(20px)] border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.08)]">
